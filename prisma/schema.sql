...
CREATE TABLE "CheckEvent" (
    ...
    "eventId" TEXT NOT NULL,
    "checkId" TEXT NOT NULL,
    "serverSequence" SERIAL NOT NULL,
    "type" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "Check_orderId_key" ON "Check"("orderId");

-- CreateIndex
CREATE INDEX "Check_locationId_status_idx" ON "Check"("locationId", "status");

-- CreateIndex
CREATE INDEX "Check_locationId_tableId_idx" ON "Check"("locationId", "tableId");

-- CreateIndex
CREATE INDEX "Check_locationId_status_createdAt_idx" ON "Check"("locationId", "status", "createdAt");
...
-- CreateIndex
CREATE INDEX "CheckItem_checkId_status_idx" ON "CheckItem"("checkId", "status");

-- CreateIndex
CREATE UNIQUE INDEX "CheckEvent_eventId_key" ON "CheckEvent"("eventId");

-- CreateIndex
CREATE INDEX "CheckEvent_checkId_idx" ON "CheckEvent"("checkId");

-- CreateIndex
CREATE INDEX "CheckEvent_checkId_serverSequence_idx" ON "CheckEvent"("checkId", "serverSequence");

-- CreateIndex
CREATE INDEX "CheckEvent_commandId_idx" ON "CheckEvent"("commandId");

-- CreateIndex
CREATE UNIQUE INDEX "ProcessedCommand_commandId_key" ON "ProcessedCommand"("commandId");

-- CreateIndex
CREATE INDEX "ProcessedCommand_commandId_idx" ON "ProcessedCommand"("commandId");

-- CreateIndex
CREATE INDEX "ProcessedCommand_createdAt_idx" ON "ProcessedCommand"("createdAt");

-- CreateIndex
CREATE INDEX "OrderNumberAllocator_locationId_businessDate_idx" ON "OrderNumberAllocator"("locationId", "businessDate");

-- CreateIndex
CREATE UNIQUE INDEX "OrderNumberAllocator_locationId_businessDate_key" ON "OrderNumberAllocator"("locationId", "businessDate");
...
-- AddForeignKey
ALTER TABLE "Check" ADD CONSTRAINT "Check_locationId_fkey" FOREIGN KEY ("locationId") REFERENCES "Location"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "CheckEvent" ADD CONSTRAINT "CheckEvent_checkId_fkey" FOREIGN KEY ("checkId") REFERENCES "Check"("id") ON DELETE CASCADE ON UPDATE CASCADE;
