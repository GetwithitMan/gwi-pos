...
async function main() {
  ...
  // Create Simulated PaymentReader
  ...
  // Bind Terminal to Simulated Reader
  ...
  console.log('Bound terminal to simulated payment reader')
  ...
  // Junction table (MenuItemModifierGroup) removed - modifier groups now use menuItemId directly
  ...
  // Junction table (MenuItemModifierGroup) removed - no modifier group linking needed
