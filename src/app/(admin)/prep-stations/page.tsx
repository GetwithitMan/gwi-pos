...
export default function PrepStationsPage() {
  ...
  const getTypeStyle = (type: string) => {
    return STATION_TYPES.find(t => t.value === type)?.color || 'bg-gray-100 text-gray-900'
  }
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="p-6 max-w-6xl mx-auto">
        ...
        {/* Stations Grid */}
        {isLoading ? (
          <div className="text-center py-12 text-gray-900">Loading stations...</div>
        ) : stations.length === 0 ? (
          <Card>
            <CardContent className="p-12 text-center">
              ...
              <p className="text-gray-900 mb-4">Create your first prep station to start routing items to kitchen displays.</p>
                ...
                <CardContent>
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between">
                      <span className="text-gray-900">Categories assigned:</span>
                      <span className="font-medium">{station.categoryCount}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-900">Item overrides:</span>
