...
export default function PitBossScreensPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      if (screensRes.ok) {
        ...
        const allScreens: KDSScreen[] = data.data.screens || []
        setScreens(allScreens.filter(s => s.screenType === 'entertainment'))
      }
  ...
  const handleDelete = async (screen: KDSScreen) => {
    if (!confirm(`Delete PitBoss screen "${screen.name}"?`)) return
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <AdminPageHeader
        title="PitBoss Screens"
        subtitle="Configure entertainment display screens for monitoring game tables, pool, bowling and more"
        breadcrumbs={[
      ...
      <div className="mx-auto max-w-4xl">
        ...
        {loading ? (
          ...
          <div className="rounded-xl bg-white p-8 text-center shadow">
            ...
            <h3 className="mt-2 text-lg font-medium text-gray-900">No PitBoss screens configured</h3>
            <p className="mt-1 text-gray-900">Add your first entertainment display screen to monitor game tables, pool, bowling and more.</p>
            <button
              onClick={handleAdd}
                ...
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <button
                      ...
                      title={copySuccess === screen.id ? 'Copied!' : 'Copy Screen URL'}
                    >
                      {copySuccess === screen.id ? (
                        <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {/* Add/Edit Modal — screenType hidden, always 'entertainment' */}
      <Modal isOpen={showModal} onClose={() => setShowModal(false)} title={editingScreen ? 'Edit PitBoss Screen' : 'Add PitBoss Screen'} size="lg">
            {error && (
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Pool Table Display"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  />
                  <p className="mt-1 text-xs text-gray-900">
                    Items turn yellow on the display after sitting this long. Alerts staff to check on activity.
                  </p>
                </div>
                <div>
                  <label className="mb-1 block text-sm font-medium text-gray-900">
                  ...
                  />
                  <p className="mt-1 text-xs text-gray-900">
                    Items turn red after sitting this long. A more urgent alert that attention is overdue. Should be greater than the Yellow Warning time above.
                  </p>
                </div>
              </div>
              <p className="text-xs text-gray-900 -mt-2">
                Common values: Yellow at 8 minutes, Red at 15 minutes. Adjust based on your entertainment area&apos;s needs.
              </p>
              ...
              <div className="space-y-3">
                <div>
                  <label className="flex items-center gap-2">
                    ...
                    />
                    <span className="text-sm text-gray-900">Play sound on new activity</span>
                  </label>
                  <p className="ml-6 text-xs text-gray-900 mt-0.5">
                    Play an audio alert when new activity arrives on this screen. Turn OFF for displays in quiet areas.
                  </p>
                </div>
                <div>
                  <label className="flex items-center gap-2">
                    <input
                      ...
                      className="h-4 w-4 rounded border-gray-300"
                    />
                    <span className="text-sm text-gray-900">Flash on new activity</span>
                  </label>
                  <p className="ml-6 text-xs text-gray-900 mt-0.5">
                    Briefly highlight the screen when new activity arrives. Turn OFF if the flashing is distracting.
                  </p>
                </div>
              </div>
              ...
              {pairingModal.loading ? (
                ...
                <>
                  <p className="mb-6 text-gray-900">
                    Enter this code on the display device to pair it
                  </p>
                  ...
                  <div className="mb-6 rounded-lg bg-blue-50 p-4 text-left text-sm text-blue-800">
                    ...
                    <ol className="mt-2 list-inside list-decimal space-y-1">
                      ...
                      <li>Go to <code className="rounded bg-blue-100 px-1">{typeof window !== 'undefined' ? window.location.origin : ''}/kds/pair</code></li>
