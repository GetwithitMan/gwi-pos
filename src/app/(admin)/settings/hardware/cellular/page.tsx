  ...
  if (loading) {
    return (
      <div className="p-6 flex items-center justify-center">
        <div className="text-gray-700">Loading cellular devices...</div>
      </div>
    )
  }
            ...
            >
              <div className="flex items-start justify-between gap-4">
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs text-gray-500 truncate" title={device.deviceFingerprint}>
                  ...
                  {/* Details row */}
                  <div className="ml-11 flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-gray-500">
                ...
                <div className="flex-shrink-0">
                  ...
                  {device.status === 'expired' && (
                    <span className="text-xs text-gray-400">Session Expired</span>
                  )}
                </div>
              </div>
            </div>
