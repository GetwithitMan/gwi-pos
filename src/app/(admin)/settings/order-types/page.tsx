                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="p-2 text-gray-900 hover:text-blue-500 hover:bg-blue-50 rounded-lg transition-colors"
                    >
                    ...
                    {!orderType.isSystem && (
                      <button
                        ...
                        className="p-2 text-gray-900 hover:text-red-500 hover:bg-red-50 rounded-lg transition-colors"
                      >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
