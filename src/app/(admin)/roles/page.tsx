      ...
      <AnimatePresence mode="wait">
        {!showModal ? (
          ...
          >
            ...
            <div className="mt-6">
              {isLoading ? (
                <div className="text-center py-12 text-gray-900">Loading roles...</div>
              ) : roles.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-900 mb-4">No roles yet. Start with a template to get set up in seconds.</p>
