...
// GET - List closed orders (paid, closed) for today
export async function GET(request: NextRequest) {
  try {
    ...
    // Get today's start of day for filtering
    ...
    const orders = await db.order.findMany({
      where: {
        ...
        parentOrderId: null, // Don't show split children in main list
        closedAt: {
          gte: today, // Only show today's closed orders
        },
