          ...
          if (mod.childModifierGroup) {
            const childGroup = await tx.modifierGroup.create({
              data: {
                ...
                displayName: mod.childModifierGroup.displayName,
                isSpiritGroup: mod.childModifierGroup.isSpiritGroup,
                ...
                tieredPricingConfig: mod.childModifierGroup.tieredPricingConfig ?? Prisma.JsonNull,
            ...
            for (const cm of mod.childModifierGroup.modifiers) {
              await tx.modifier.create({
                data: {
                  ...
                  swapTargets: cm.swapTargets ?? Prisma.DbNull,
                  customPreModifiers: cm.customPreModifiers ?? Prisma.DbNull,
        ...
        for (const mod of sourceGroup.modifiers) {
          await tx.modifier.create({
            data: {
              ...
              liteMultiplier: mod.liteMultiplier,
              extraMultiplier: mod.extraMultiplier,
              ...
              printerIds: mod.printerIds ?? Prisma.DbNull,
              ...
              swapTargets: mod.swapTargets ?? Prisma.DbNull,
              customPreModifiers: mod.customPreModifiers ?? Prisma.DbNull,
    ...
    return NextResponse.json({
      data: {
        ...
        modifiers: group.modifiers.map(m => ({
          ...
          isLabel: m.isLabel ?? false,
          ingredientId: m.ingredientId,
          ingredientName: (m as any).ingredient?.name || null,
          childModifierGroupId: m.childModifierGroupId,
          printerRouting: m.printerRouting,
          printerIds: m.printerIds,
          displayName: m.displayName,
