...
export default function PrintSettingsEditor({
  ...
  return (
    <Modal isOpen={true} onClose={onCancel} title="Print Template Settings" size="4xl" variant="default">
      <div className="-m-5 bg-gray-800 rounded-b-2xl flex flex-col max-h-[75vh]">
