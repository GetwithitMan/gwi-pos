...
// SVG Icons as components for reuse (all decorative — paired with text labels)
const Icons = {
  grid: (
...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    adminItems: [
      ...
      { name: 'Tip Groups', href: '/tip-groups', icon: Icons.customers },
      ...
      { name: 'Berg Dispense Log', href: '/reports/berg-dispense', icon: Icons.liquor },
      { name: 'Berg Variance', href: '/reports/berg-variance', icon: Icons.chart },
      { name: 'Berg Unmatched', href: '/reports/berg-unmatched', icon: Icons.void },
      { name: 'Berg Health', href: '/reports/berg-health', icon: Icons.hardware },
