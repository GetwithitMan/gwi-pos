    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3 px-4 py-3 border-b border-gray-200">
          ...
          />
          <kbd className="hidden sm:inline-flex items-center px-1.5 py-0.5 text-xs text-gray-600 bg-gray-100 rounded border border-gray-200">
            ESC
          </kbd>
        </div>
          ...
          {results.length === 0 ? (
            ...
            <>
              {isShowingRecent && results.length > 0 && (
                <div className="px-4 py-1.5 text-xs font-semibold text-gray-900 uppercase tracking-wider">
                  Recent
                </div>
              )}
              {results.map((page, i) => (
