...
const settingsSections: SettingsSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Modifier Templates', href: '/menu/templates' },
      { name: 'Pizza', href: '/settings/pizza' },
      { name: 'Discounts', href: '/settings/discounts' },
      { name: 'Pricing Rules', href: '/settings/happy-hour' },
      { name: 'Upsell Prompts', href: '/settings/upsell-rules' },
      { name: 'Catering', href: '/settings/catering' },
      { name: 'Import', href: '/settings/menu/import' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Website Settings', href: '/settings/online-ordering/site' },
    ],
  },
  {
    title: 'Inventory',
    ...
    items: [
      ...
      { name: 'Quick Adjust', href: '/settings/inventory/quick-adjust' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Customer Portal', href: '/settings/venue-portal' },
      { name: 'Rewards Catalog', href: '/settings/venue-portal/rewards' },
    ],
  },
  {
    title: 'Memberships',
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Training Mode', href: '/settings/training' },
    ],
  },
  {
    title: 'Tips',
  ...
  },
  {
    ...
    adminItems: [
      ...
      { name: 'Feedback', href: '/settings/reports/feedback' },
      { name: 'Waste', href: '/settings/reports/waste' },
      { name: 'Hourly', href: '/reports/hourly' },
      { name: 'Daypart', href: '/reports/daypart' },
      { name: 'Flash Dashboard', href: '/reports/flash' },
      { name: 'Trends', href: '/reports/trends' },
      { name: 'Labor Cost', href: '/reports/labor-cost' },
      { name: 'Food Cost', href: '/reports/food-cost' },
      { name: 'Speed of Service', href: '/reports/speed-of-service' },
      { name: 'Server Performance', href: '/reports/server-performance' },
      { name: 'Payment Methods', href: '/reports/payment-methods' },
      { name: 'Cash Liabilities', href: '/reports/cash-liabilities' },
      { name: 'Menu Engineering', href: '/reports/menu-engineering' },
      { name: 'Tax Exempt', href: '/reports/tax-exempt' },
      { name: 'Gratuity', href: '/reports/gratuity' },
      { name: 'Tip Adjustments', href: '/reports/tip-adjustments' },
      { name: 'Variance', href: '/reports/variance' },
      { name: 'Forecasting', href: '/reports/forecasting' },
      { name: 'Vendor Comparison', href: '/reports/vendor-comparison' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Health Status', href: '/settings/hardware/health' },
      { name: 'Scales', href: '/settings/hardware/scales' },
    ],
  },
  {
    title: 'Security',
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Berg Dispensers', href: '/settings/integrations/berg' },
