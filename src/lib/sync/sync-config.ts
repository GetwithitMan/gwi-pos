...
export const SYNC_MODELS: Readonly<Record<string, SyncModelConfig>> = {
  ...
  HouseAccount:           { direction: 'downstream', owner: 'cloud', priority: 230, batchSize: 50 },
  ...
  Ingredient:             { direction: 'downstream', owner: 'cloud', priority: 234, batchSize: 100 },
  IngredientCategory:     { direction: 'downstream', owner: 'cloud', priority: 235, batchSize: 50 },
  MenuItemRecipe:         { direction: 'downstream', owner: 'cloud', priority: 236, batchSize: 100 },
  ...
  Reservation:            { direction: 'downstream', owner: 'cloud', priority: 261, batchSize: 100 },
  ...
  EntertainmentWaitlist:  { direction: 'downstream', owner: 'cloud', priority: 266, batchSize: 100 },
