...
export const SYNC_MODELS: Readonly<Record<string, SyncModelConfig>> = {
  ...
  PricingOptionGroup:     { direction: 'downstream', owner: 'cloud', priority: 223, batchSize: 100, businessKey: ['menuItemId', 'name'] },
  PricingOption:          { direction: 'downstream', owner: 'cloud', priority: 224, batchSize: 100, businessKey: ['groupId', 'label'] },
