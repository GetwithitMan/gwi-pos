...
const hashPath = path.join(process.cwd(), 'prisma/schema-hash.txt')
...
console.log(`[generate-version-contract] Schema version: ${schemaVersion}, ${files.length} migrations, hash: ${schemaSha256?.substring(0, 16) ?? 'N/A'}...`)
