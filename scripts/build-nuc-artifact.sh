...
cat > "$STAGING/artifact-metadata.json" << METAJSON
{
  ...
  "gitSha": "${GIT_SHA}",
  "artifactUrl": "https://pub-15bf4245be0e4c05b570d31988004d09.r2.dev/releases/${RELEASE_ID}/${ARTIFACT_FILENAME}",
  "artifactSigUrl": "https://pub-15bf4245be0e4c05b570d31988004d09.r2.dev/releases/${RELEASE_ID}/${ARTIFACT_FILENAME}.minisig",
