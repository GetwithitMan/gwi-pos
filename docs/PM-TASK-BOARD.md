...
| T-080 | Full Pricing Program System (Phase 1+4) | PM: Payments | 2026-02-20 | Phase 1: PricingProgram interface, 5 strategy functions, getPricingProgram() backward-compat helper. Phase 4: settings viewer shows all 5 models. Phases 2/3/5/6 remain. Commit `d295212` |
