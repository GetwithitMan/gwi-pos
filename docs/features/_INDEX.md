...
| **Android Update System** | Fleet-wide APK delivery (register/PAX/KDS/CFD): MC release registry + HMAC fleet routes, R2 artifact hosting, NUC proxy, device integrity gate, stale-token recovery | [../operations/ANDROID-UPDATE-RUNBOOK.md](../operations/ANDROID-UPDATE-RUNBOOK.md) · [Status 2026-04-18](../operations/ANDROID-UPDATE-STATUS-2026-04-18.md) · [Security checklist](../operations/PRE-LAUNCH-SECURITY-CHECKLIST.md) · [KDS auth decision](../decisions/2026-04-18-kds-update-auth.md) | Active (engineering-complete; 3/4 apps canary-validated, CFD canary pending) | pos, mission-control, android-register, pax-a6650, kds-android, cfd | Mission Control, R2 (Cloudflare), Hardware (device pairing), Cellular Auth |
